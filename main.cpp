...
int main()
{
    ...
    *************************************************************************/   
    ...
    Size board_size = Size(7,5);            /****    定标板上每行、列的角点数       ****/  
    ...
    *************************************************************************/   
    ...
    for (int i=0;  i<image_count;  i++) 
    {
        ...
        cout<<"NO."<<i+1<<"AVERAGE ERROR"<<err<<"像素"<<endl;   
        fout<<"NO."<<i+1<<"AVERAGE ERROR"<<err<<"像素"<<endl;   
    }   
    cout<<"TOTAL AVERAGE ERROR:"<<total_err/image_count<<"像素"<<endl;   
    fout<<"TOTAL AVERAGE ERROR:"<<total_err/image_count<<"像素"<<endl<<endl;   
